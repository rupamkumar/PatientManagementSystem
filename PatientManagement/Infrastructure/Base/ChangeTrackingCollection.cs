...
namespace Infrastructure.Base
{
        ...
        where T : class, IValidatableTrackingObject
    {
        ...
        protected override void OnCollectionChanged(NotifyCollectionChangedEventArgs e)
        {
            ...
            var added = this.Where(current =>  _originalCollection.All(original =>  original != Items.Last()));
            
            var removed = _originalCollection.Where(original => this.All(current => current != original));
